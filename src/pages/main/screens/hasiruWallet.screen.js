    ...
    <ScrollView style={styles.scrollView}>
      <SafeAreaView style={styles.container}>
        ...
        <MetropolisText medium style={styles.text}>
          Recharge for a minimum of <MetropolisText bold>$450</MetropolisText>{' '}
          to begin Subscription
        </MetropolisText>
        <View style={[styles.cashPresetContainer, styles.marginTop]}>
          <CashCard left label="$500" />
          <CashCard mid label="$2000" />
          <CashCard right label="$2500" />
        </View>
        <View style={styles.cashPresetContainer}>
          <CashCard left label="$500" />
          <CashCard mid label="$2000" />
          <CashCard right label="$2500" />
        </View>
        <AddMoneyToWalletButton />
      </SafeAreaView>
    </ScrollView>
  )
}
...
export default HasiruWalletScreen
